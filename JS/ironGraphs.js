async function ironGraphs() {
    fetch('https://fergueri.github.io/LeagueAPI/iron.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        const ctx = document.getElementById("championPickR1").getContext("2d");
    ...
    fetch('https://fergueri.github.io/LeagueAPI/iron.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        // Get the canvas element and create a Chart.js instance
        const ctx = document.getElementById("championWinR1").getContext("2d");
        const chart = new Chart(ctx, {
            type: "bar",
            data: {
    ...
    fetch('https://fergueri.github.io/LeagueAPI/iron.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        // Get the canvas element and create a Chart.js instance
        const ctx = document.getElementById("championBanR1").getContext("2d");
        const chart = new Chart(ctx, {
            type: "bar",
            data: {
