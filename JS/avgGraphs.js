...
async function avgGraphs() {
    fetch('https://fergueri.github.io/LeagueAPI/average.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        const ctx = document.getElementById("championPickR4").getContext("2d");
    ...
    fetch('https://fergueri.github.io/LeagueAPI/average.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        // Get the canvas element and create a Chart.js instance
        const ctx = document.getElementById("championWinR4").getContext("2d");
        const chart = new Chart(ctx, {
            type: "bar",
            data: {
    ...
    fetch('https://fergueri.github.io/LeagueAPI/average.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        // Get the canvas element and create a Chart.js instance
        const ctx = document.getElementById("championBanR4").getContext("2d");
        const chart = new Chart(ctx, {
            type: "bar",
            data: {
