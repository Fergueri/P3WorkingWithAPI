async function masGraphs() {
    fetch('https://fergueri.github.io/LeagueAPI/master.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        const ctx = document.getElementById("championPickR3").getContext("2d");
    ...
    fetch('https://fergueri.github.io/LeagueAPI/master.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        // Get the canvas element and create a Chart.js instance
        const ctx = document.getElementById("championWinR3").getContext("2d");
        const chart = new Chart(ctx, {
            type: "bar",
            data: {
    ...
    fetch('https://fergueri.github.io/LeagueAPI/master.json').then((response) => response.json()).then((data) => { // Sort champions by pick rate
        ...
        // Get the canvas element and create a Chart.js instance
        const ctx = document.getElementById("championBanR3").getContext("2d");
        const chart = new Chart(ctx, {
            type: "bar",
            data: {
